    ...
    var body: some Scene {
        WindowGroup {
            TabView {
                ...
                GuidedWalkthroughView()
                    .tabItem { Label("Walkthrough", systemImage: "book") }
        ...
        // ✅ Single immersive space for ALL impairments
        ImmersiveSpace(id: "impairmentImmersive") {
            ImpairmentImmersiveOverlay()     // <— reads appState.selectedImpairment
                .environmentObject(appState)
                .ignoresSafeArea()
        }
        .immersionStyle(selection: $immersionStyle, in: .mixed)

        // ——— your existing window groups ———
        WindowGroup(id: "mainContent") {
        ...
        WindowGroup(id: "macularDegenerationInteractive") {
            MacularDegenerationInteractiveView(imageName: "gl_scene_park")
                .environmentObject(appState)
        }
        ...
        // ❌ REMOVE these duplicate ImmersiveSpace blocks:
        // ImmersiveSpace(id: "glaucomaImmersive") { ... }
        // (There must be only one ImmersiveSpace per ID)
